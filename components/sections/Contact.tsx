            ...
            <div className="bg-card p-8 rounded-xl border border-border">
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  <a href="https://github.com/jasonsaputra" className="bg-card hover:bg-primary/10 p-3 rounded-full text-foreground hover:text-primary transition-colors">
                  ...
                  <a href="https://www.linkedin.com/in/jason-saputra/" className="bg-card hover:bg-primary/10 p-3 rounded-full text-foreground hover:text-primary transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
